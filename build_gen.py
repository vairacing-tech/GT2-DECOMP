...
cpp_targets_autogen_end = [
    ...
    "src/ovr1/func_80048208.c",
    "src/ovr1/func_80048258.c",
    ...
    "src/ovr5/func_80014FEC.c",
    "src/autogen/ovr5/func_8001503C.c",
    "src/ovr5/func_800153B4.c",
    "src/autogen/ovr5/func_8001706C.c",
    "src/ovr5/func_80018768.c",
    ...
    "src/ovr5/func_8001DCD0.c",
    "src/ovr5/func_8001DD3C.c",
    "src/autogen/ovr5/func_8001DDAC.c",
    "src/ovr5/func_8001E26C.c",
    "src/ovr5/func_800204D8.c",
    "src/ovr5/func_800209F8.c",
    "src/ovr5/func_80020BDC.c",
    "src/ovr5/func_80020C00.c",
    "src/ovr5/func_80020C24.c",
    "src/ovr5/func_80020D48.c",
    "src/ovr5/func_800218BC.c",
    "src/ovr5/func_80021A40.c",
    "src/ovr5/func_80021BEC.c",
    "src/ovr5/func_80021C38.c",
    "src/ovr5/func_80021CB4.c",
    "src/ovr5/func_80022368.c",
    "src/ovr5/func_8002237C.c",
    "src/ovr5/func_800223B0.c",
    ...
    "src/ovr5/gt2_ovr5_format_number.c",
    "src/ovr5/gt2_ovr5_get_main_car_part_number_by_car_id.c",
    "src/ovr5/gt2_ovr5_get_machine_test_game_mode.c",
    "src/autogen/ovr5/gt2_ovr5_get_stat_widget_display_value.c",
    "src/ovr5/gt2_ovr5_is_event_synthesizer.c",
    "src/ovr5/gt2_ovr5_is_international_league.c",
    "src/ovr5/gt2_ovr5_is_gt_world_cup.c",
    "src/autogen/ovr5/gt2_ovr5_ui_can_buy_caller0.c",
    "src/autogen/ovr5_17_1.c",
    "src/autogen/ovr5_17_2.c",
    "src/autogen/ovr5_17_2_1.c",
    "src/autogen/ovr5_17_3.c",
    "src/autogen/ovr5_17_4.c",
    "src/autogen/ovr5_17_5.c",
    "src/autogen/ovr5_17_6.c",
    "src/autogen/ovr5_17_6_1.c",
    "src/autogen/ovr5_17_6_1_1.c",
    "src/autogen/ovr5_17_6_3.c",
    "src/autogen/ovr5_17_6_4.c",
    "src/autogen/ovr5_17_6_5.c",
    "src/ovr6/gt2_ovr6_task4.c",
]
...
cpp_targets_end = [
    ...
    "src/start/gt2_main_task200_spu_voice00_vol.c",
    "src/start/gt2_main_task202.c",
    ...
    "src/start/gt2_main_task0b2101.c",
    "src/start/gt2_main_task0b1100.c",
    "src/start/gt2_load_overlay_default.c",
    "src/start/gt2_load_overlay.c",
    "src/start/gt2_overlay_default_entrypoints.c",
...
target_splits = [5, 48, -1, 0, 0, 17, -1, 82]
